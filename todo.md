...
- `IntegrationLogExtensions.cs`, `Services/IIntegrationEventLogService.cs`, `Services/IntegrationEventLogService.cs`, `Utilities/ResilientTransaction.cs` not yet added.

Commits: `0e6e311`, `21c9deb`, `848efca`, `d4f9b3b`.
